...
from elemental_platforming_game.examples.constants import *
...
def create_floor(space, sprite_list):
    ...
    for x in range(-1000, 2000, SPRITE_SIZE):
        y = SPRITE_SIZE / 2
        sprite = PymunkSprite(path_utils.get_resource_file_path("images/grassMid.png"), x, y, scale=0.5, body_type=pymunk.Body.STATIC)
...
def create_level_1(space, static_sprite_list, dynamic_sprite_list):
    ...
    for column in range(6):
        for row in range(column):
            ...
            sprite = PymunkSprite(path_utils.get_resource_file_path("images/boxCrate_double.png"), x, y, scale=0.5, friction=0.4)
